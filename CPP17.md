...
Note that `std::byte` is simply an enum, and braced initialization of enums become possible thanks to [direct-list-initialization of enums](/modern-cpp-features-docs/cpp_17/Language/#direct-list-initialization-of-enums).
